...
/**
 * Application event published after a forgot-password request
 * is successfully committed to the database.
 *
 * <p>Contains the raw reset token for email delivery.
...
public final class PasswordResetRequestedEvent {
    ...
    public PasswordResetRequestedEvent(UUID userId, String recipientEmail,
