...
/**
 * Activity-log-module-specific exception handler.
 *
 * <p>Handles exceptions from the activity module and maps them to the unified
 * {@link ApiErrorResponse} format. Reuses domain exceptions from project, milestone,
 * task, and workspace modules.
 *
 ...
 */
@RestControllerAdvice(basePackages = "com.milestoneflow.activity")
@Order(Ordered.HIGHEST_PRECEDENCE)
public class ActivityLogExceptionHandler extends GlobalExceptionHandler {

    public ActivityLogExceptionHandler(Clock clock) {
        super(clock);
    }
    ...
    /**
     * Handles task not found or cross-milestone/project/workspace access.
    ...
    /**
     * Handles workspace access denied for activity log queries.
