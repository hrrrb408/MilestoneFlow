...
class ProjectSecurityIT extends AbstractIntegrationTest {
    ...
    class CrossWorkspaceIsolation {
        ...
        void shouldReturn404WrongWorkspace() {
            ...
            ResponseEntity<Map> response = restTemplate.exchange(
                    ...
                    new HttpEntity<>(authHeadersOnlyA), Map.class);
    ...
    class AnonymousAccess {
        ...
        @Test
        @DisplayName("should reject anonymous project creation")
        void shouldRejectAnonymousCreate() {
            var body = Map.of("name", "Anonymous Project");
            var headers = new HttpHeaders();
            headers.setContentType(MediaType.APPLICATION_JSON);
        ...
        @Test
        @DisplayName("should reject anonymous project list")
        ...
        @Test
        @DisplayName("should reject anonymous project detail")
        void shouldRejectAnonymousDetail() {
            ResponseEntity<Map> response = restTemplate.exchange(
                    "/workspaces/" + workspaceIdA + "/projects/" + UUID.randomUUID(), HttpMethod.GET,
                    new HttpEntity<>(new HttpHeaders()), Map.class);
        ...
        @Test
        @DisplayName("should reject anonymous project update")
        void shouldRejectAnonymousUpdate() {
            ...
            ResponseEntity<Map> response = restTemplate.exchange(
                    "/workspaces/" + workspaceIdA + "/projects/" + UUID.randomUUID(), HttpMethod.PATCH,
                    new HttpEntity<>(body, headers), Map.class);
